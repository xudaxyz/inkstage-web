...
export const API_ENDPOINTS = {
    ...
    FRONT: {
        ...
        // 文章相关
        ARTICLE: {
            DETAIL: (id: number) => `/front/article/${id}`, // 获取文章详情
            ...
            PERMANENT_DELETE: (id: number) => `/front/article/permanent-delete/${id}`, // 彻底删除文章
            ...
            COLLECTIONS: {
                ...
                UPDATE_FOLDER: (folderId: number) => `/front/article/collections/folders/${folderId}`, // 更新收藏文件夹
                DELETE_FOLDER: (folderId: number) => `/front/article/collections/folders/${folderId}`, // 删除收藏文件夹
        ...
        TAG: {
            ...
            DETAIL: (id: number) => `/front/tag/${id}`, // 根据ID获取标签
            BY_ARTICLE: (articleId: number) => `/front/tag/article/${articleId}`, // 根据文章ID获取标签
        },
        ...
        CATEGORY: {
            ...
            DETAIL: (id: number) => `/front/category/${id}`, // 根据ID获取分类
        },
        ...
        COMMENT: {
            ...
            DELETE: (id: number) => `/front/comment/delete/${id}`, // 删除评论
        },
        ...
        SEARCH: {
            ...
            HISTORY: {
                ...
                DELETE: (id: number) => `/front/search/history/delete/${id}`, // 删除搜索历史
    ...
    ADMIN: {
        ...
        TAG: {
            ...
            UPDATE: (id: number) => `/admin/tag/${id}`, // 更新标签
            DELETE: (id: number) => `/admin/tag/${id}`, // 删除标签
            UPDATE_STATUS: (id: number) => `/admin/tag/${id}/status`, // 更新标签状态
        },
        ...
        CATEGORY: {
            ...
            UPDATE: (id: number) => `/admin/category/${id}`, // 更新分类
            DELETE: (id: number) => `/admin/category/${id}`, // 删除分类
            UPDATE_STATUS: (id: number) => `/admin/category/${id}/status`, // 更新分类状态
        },
    },
