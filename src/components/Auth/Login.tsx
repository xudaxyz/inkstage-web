      ...
      >
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-sm">
            ...
            <Link to="/register" className="ml-1 text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-200">
              点击注册
            </Link>
          </div>
        </div>
        ...
        <Form.Item
          name="account"
          rules={[
            { required: true, message: loginType === 'code' ? '请输入邮箱或手机号' : '请输入用户名、邮箱或手机号' }
          ]}
          className="mb-4"
        >
          <Input
        ...
        <div className="text-center">
          <a href="#" className="text-sm text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-200">
            已有账号，忘记密码？
          </a>
        </div>
      </Form>
