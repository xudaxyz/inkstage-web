...
import { Card, Input, Button, Form, Switch, Select, Upload, message, Typography } from 'antd';
import { SearchOutlined, SaveOutlined, UploadOutlined, MailOutlined, SafetyOutlined, GlobalOutlined } from '@ant-design/icons';
