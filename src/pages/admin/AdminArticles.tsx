...
import articleService, {type AdminArticleList} from '../../services/articleService';
...
const AdminArticles: React.FC = () => {
    ...
    const handleStatusChange = (value: ArticleStatusEnum) => {
    ...
    // 打开编辑文章模态框
    const handleEditArticle = (article: AdminArticleList) => {
        setIsEditing(true);
    ...
    // 打开查看文章模态框
    const handleViewArticle = async (article: AdminArticleList) => {
        try {
