...
const verificationOptions = [
  {
    ...
    label: VerificationStatusMap[VerificationStatusEnum.VERIFIED]
  },
  {
    value: VerificationStatusEnum.UNVERIFIED,
    label: VerificationStatusMap[VerificationStatusEnum.UNVERIFIED]
  }
];
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (userRole: UserRoleEnum | undefined): React.ReactNode => (
        <Tag color={getRoleColor(userRole)}>{userRole ? UserRoleEnumLabel[userRole] : '未知'}</Tag>
      )
    },
    {
      title: '状态',
      ...
      render: (status: UserStatusEnum): React.ReactNode => (
        <Tag color={getStatusColor(status)}>{UserStatusEnumLabel[status]}</Tag>
      )
    },
    {
      title: '注册时间',
      ...
      <div>
        ...
        <Card variant={'borderless'} className="border-b border-gray-100 mb-4">
          <div className="flex flex-col md:flex-row gap-4 flex-wrap">
            ...
            />
            <DatePicker placeholder="结束日期" style={{ width: '100%', maxWidth: 150 }}
        ...
        >
          {currentUser && (
            <div className="space-y-0 flex flex-col">
              ...
              <div
                className={
                  currentUser.coverImage
                    ...
                    : 'bg-linear-to-r from-blue-500 to-indigo-600 text-white p-6'
                }
              >
                {currentUser.coverImage && (
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <div className="flex flex-wrap items-center justify-start gap-3 mb-3">
                        ...
                        <span>
                          {currentUser.gender === GenderEnum.MALE ? (
                            <ManOutlined style={{ color: 'blue' }} />
                          ) : currentUser.gender === GenderEnum.FEMALE ? (
                      ...
                      <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-4">
                        ...
                        <Tag
                          color={getStatusColor(currentUser.userStatus)}
                      ...
                      {currentUser.signature && (
                        <p className="text-white/90 mb-4 text-sm italic max-w-2xl mx-auto md:mx-0">
                          {currentUser.signature}
                        </p>
                      )}
              ...
              {/* 标签页导航 */}
              <div className="flex-1 h-112.5 overflow-auto bg-white">
                <Tabs activeKey={activeTab} onChange={setActiveTab}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-col p-3 bg-gray-50 rounded-md">
                          ...
                          <span className="text-gray-800 text-sm">
                          {VerificationStatusMap[currentUser.emailVerified]}
                        </span>
                        </div>
                        <div className="flex flex-col p-3 bg-gray-50 rounded-md">
                          <span className="text-xs text-gray-500 mb-1">手机验证</span>
                          <span className="text-gray-800 text-sm">
                          {VerificationStatusMap[currentUser.phoneVerified]}
                        </span>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="w-full">
                      {currentUser.recentArticles && currentUser.recentArticles.length > 0 ? (
                        <div className="space-y-3 max-h-75 overflow-auto">
                        ...
                        <div className="text-center py-8 text-gray-500">暂无发布的文章</div>
                      )}
                    </div>
                  </TabPane>
                  ...
                  >
                    {currentUser.recentComments && currentUser.recentComments.length > 0 ? (
                      ...
                      <div className="text-center py-8 text-gray-500">暂无发布的评论</div>
                    )}
                  </TabPane>
                </Tabs>
              </div>
            ...
            <div className="py-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input value={editUser.registerIp || '未知'} disabled className="w-full" />
                </div>
              </div>
            </div>
          )}
        ...
        <Modal
          ...
          footer={[
            ...
            <Button key="save" type="primary" onClick={handleSaveRoleChange} loading={editLoading}
                    className="px-6 py-2">
              保存修改
            </Button>
          ]}
