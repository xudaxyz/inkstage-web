...
import type { IndexArticleList, BannerArticle, LatestArticle } from '../../types/article';
import articleService from '../../services/articleService';
import type { FrontendCategory as Category } from '../../types/category';
...
const Home: React.FC = () => {
  ...
  const [tags, setTags] = useState<FrontTag[]>([]);
  ...
  // 获取轮播图文章
  const fetchBannerArticles = async () : Promise<void> => {
  ...
  // 获取最新文章
  const fetchLatestArticles = async () : Promise<void> => {
