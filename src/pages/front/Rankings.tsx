                        ...
                        >
                          <div className="flex flex-col sm:flex-row w-full gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {/* 作者信息 */}
                              <div className="flex items-center text-gray-500 dark:text-gray-400 text-sm mb-3 flex-wrap gap-2">
                                ...
                                {/* 统计数据 */}
                                <div className="flex items-center text-gray-400 dark:text-gray-500 text-xs flex-wrap gap-4">
                        ...
                        >
                          <div className="flex items-center w-full gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {/* 统计数据 */}
                              <div className="flex items-center text-gray-500 dark:text-gray-400 text-xs gap-2 sm:gap-3 flex-wrap">
