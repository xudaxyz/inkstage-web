...
import { Button, Card, Input, Select, Upload, message, Space, Form, Radio, Switch } from 'antd';
...
import {
    ...
    SendOutlined,
    SwapLeftOutlined,
    InboxOutlined, MoonOutlined, SunOutlined
...
const CreateArticle: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
            {/* 顶部导航栏 */}
            <header
                className="h-16 bg-white dark:bg-gray-800 border-b dark:border-b border-gray-200 dark:border-gray-700 flex items-center px-[5%] sticky top-0 z-10 shadow-sm">
                {/* 左侧：Logo和标题 */}
          ...
          <span
            ...
            InkStage
                    ...
                    <span
                        className="text-base items-center font-medium text-gray-800 dark:text-gray-300">{isEditMode ? '编辑文章' : '写文章'}</span>
                </div>
                    ...
                    >
                        ...
                        <div className="flex gap-16 mb-6">
                            ...
                            <div className="w-1/5 min-w-[120px]">
                                <label
                                    className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">分类</label>
                                <Form.Item
                                    name="category"
                            ...
                            <div className="flex-2">
                                <label
                                    className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">标签</label>
                                <div>
                        ...
                        <div className="flex gap-32 mb-8">
                            ...
                            <div className="w-2/5">
                                <label
                                    className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">发布设置</label>
                                <div className="space-y-5">
                                    {/* 是否允许评论 */}
                                    <div className="flex items-center">
                                        <span
                                            className="w-32 text-sm text-[#595959] dark:text-gray-400 font-medium">是否允许评论</span>
                                    ...
                                    <div className="flex items-center">
                                        <span
                                            className="w-32 text-sm text-[#595959] dark:text-gray-400 font-medium">文章类型</span>
                                        <div className="flex-1 text-[#595959]">
                                    ...
                                    <div className="flex items-center">
                                        <span
                                            className="w-32 text-sm text-[#595959] dark:text-gray-400 font-medium">是否允许转发</span>
                                        <div className="flex-1 text-[#595959]">
                                    ...
                                    <div className="flex items-center">
                                        <span
                                            className="w-32 text-sm text-[#595959] dark:text-gray-400 font-medium">是否公开</span>
                                        <div className="flex-1 text-[#595959]">
