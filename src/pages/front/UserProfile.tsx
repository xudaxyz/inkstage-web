                    ...
                    <>
                        ...
                        <div className="relative mb-12 overflow-hidden rounded-2xl shadow-xl">
                            ...
                            >
                                ...
                                {/* 用户信息叠加在封面图片上 */}
                                <div
                                    className="absolute bottom-8 left-8 flex flex-col md:flex-row items-start gap-8 w-full max-w-5xl">
                                    {/* 头像 */}
                                    ...
                                    <div className="text-white flex-1">
                                        ...
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <span
                                                className="text-sm px-3 py-1 bg-white/20 rounded-full backdrop-blur-sm">
                            ...
                            <span style={{ color: '#1890ff' }}><ManOutlined/></span>
                                        ...
                                        <div className="flex flex-wrap items-center gap-8">
                                            <div className="flex flex-col items-center group">
                                                <div
                                                    className="font-semibold text-2xl mb-1 group-hover:text-blue-300 transition-colors">{user.articleCount}</div>
                                                <div className="text-xs text-gray-200">文章数</div>
                                            </div>
                                            <div className="flex flex-col items-center group">
                                                <div
                                                    className="font-semibold text-2xl mb-1 group-hover:text-blue-300 transition-colors">{user.followerCount}</div>
                                                <div className="text-xs text-gray-200">粉丝数</div>
                                            </div>
                                            <div className="flex flex-col items-center group">
                                                <div
                                                    className="font-semibold text-2xl mb-1 group-hover:text-blue-300 transition-colors">{user.followingCount}</div>
                        ...
                        <div className="mb-16">
                            <div className="bg-white dark:bg-gray-800/50 rounded-xl shadow-md overflow-hidden border-0">
                                <div className="px-6 py-5 border-b dark:border-b border-gray-100 dark:border-gray-600">
                                    <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">TA的全部文章
                                    </h3>
                                </div>
                                {articlesLoading ? (
                                            ...
                                            {articles.map((article) => (
                                                ...
                                                >
                                                    <div className="flex flex-col md:flex-row gap-6">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    >
                                                                        <button
                                                                            className="text-gray-400 hover:text-blue-600 transition-colors p-2 rounded-full hover:bg-gray-100 transform hover:scale-110">
                                                        ...
                                                        {article.coverImage && (
                                                            <div
                                                                className="w-full md:w-56 h-36 rounded-lg overflow-hidden shrink-0 shadow-md transform transition-all duration-300 group-hover:scale-105">
