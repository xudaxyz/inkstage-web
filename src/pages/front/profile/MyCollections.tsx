                    ...
                    >
                        {loadingFolders ? (
                            ...
                            <>
                                {/* 全部收藏 */}
                                <div
                                    className={'flex items-center px-3 py-2 pr-2 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 mb-2'}
                                ...
                                <div className="flex items-center px-3 justify-between mb-3">
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="font-medium text-secondary-500 dark:text-gray-300">我的收藏夹</span>
                                    </div>
                                    <Button
                                        type="text"
                                        size="small"
                                    ...
                                    >
                                        {showFolderList ? <UpOutlined style={{ fontSize: '14px' }}/> :
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {/* 第二行：简介 */}
                                        <div
                                            className="text-sm text-secondary-500 dark:text-gray-300 mb-4 line-clamp-2">
                                            {collection.summary}
                                        </div>
                                        ...
                                        <div className="flex flex-wrap items-center justify-between">
                                            <div
                                                className="flex items-center gap-3 justify-between text-sm text-secondary-500 dark:text-gray-400">
                                                {/*原创*/}
                                                <div className="flex items-center">
                                                    <Tag variant="solid"
                                                         color={'gold'}>
